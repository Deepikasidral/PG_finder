    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <!-- Inline CSS to push the button to the right -->
                <a class="btn btn-outline-success" href="signin.php" style="margin-left: auto;">Sign In</a>
            </div>
        </div>
    </nav>
</header>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="img/backg1.jpeg" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/backg2.jpeg" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/backg3.jpeg" alt="Third slide">
            </div>
        </div>
