...
$id1 = isset($_POST['flatID']) ? $_POST['flatID'] : '';
$room_name = isset($_POST['roomname']) ? $_POST['roomname'] : '';
$address = isset($_POST['address']) ? $_POST['address'] : '';
$flat_type = isset($_POST['flatType']) ? $_POST['flatType'] : '';
$facilities = isset($_POST['facilities']) ? $_POST['facilities'] : '';
$rooms_available = isset($_POST['no_room']) ? $_POST['no_room'] : '';
$area_name = isset($_POST['areaName']) ? $_POST['areaName'] : '';
$building_name = isset($_POST['buildingname']) ? $_POST['buildingname'] : '';
$no_of_roommates = isset($_POST['noOfRoommates']) ? $_POST['noOfRoommates'] : '';
$gender = isset($_POST['gender']) ? $_POST['gender'] : '';
$landmark = isset($_POST['landmark']) ? $_POST['landmark'] : '';
$google_embed = isset($_POST['googleEmbed']) ? $_POST['googleEmbed'] : '';
$price = isset($_POST['price']) ? $_POST['price'] : '';
$owner_name = isset($_POST['ownername']) ? $_POST['ownername'] : '';
$owner_mobile = isset($_POST['ownermobile']) ? $_POST['ownermobile'] : '';
$owner_address = isset($_POST['owneraddress']) ? $_POST['owneraddress'] : '';


// Handle file uploads
if (isset($_FILES['flatImage1']) && $_FILES['flatImage1']['error'] == 0) {
    $target_file1 = "uploads/" . basename($_FILES['flatImage1']['name']);
    move_uploaded_file($_FILES['flatImage1']['tmp_name'], $target_file1);
}

if (isset($_FILES['flatImage2']) && $_FILES['flatImage2']['error'] == 0) {
    $target_file2 = "uploads/" . basename($_FILES['flatImage2']['name']);
    move_uploaded_file($_FILES['flatImage2']['tmp_name'], $target_file2);
}

if (isset($_FILES['flatImage3']) && $_FILES['flatImage3']['error'] == 0) {
    $target_file3 = "uploads/" . basename($_FILES['flatImage3']['name']);
    move_uploaded_file($_FILES['flatImage3']['tmp_name'], $target_file3);
}
